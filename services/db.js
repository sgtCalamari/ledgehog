...
module.exports = function (dbString) {
  ...
  // module functions
  module.getAccountDetails = async function(accountId) {
    /* returns object with:
    accountId: String,
    accountName: String,
  ...
  module.getBalanceSummary = async function() {
    /* returns object with:
  ...
  module.getCreateTransactionDetails = async function(accountId) {
    /* returns object with:
    accountId: String,
    accountName: String,
  ...
  module.createTransaction = async function(transactionDetails) {
    /* accepts object with:
    date: Date
    account: String
    description: String
  ...
  module.getTransactionCategoriesSummary = async function() {
    /* returns object with:
  ...
  module.getCreateCategoryDetails = async function() {
    /* returns object with:
  ...
  module.createCategory = async function(categoryDetails) {
    /* accepts object with:
    description: String
    parentCategory: String
    */
  ...
  module.modifyTransaction = async function(transactionDetail) {
    /* accepts object with:
    id: ObjectId
    update: Object
      date: Date
  ...
  module.createAccount = async function(accountDetails) {
    /* accepts object with:
    name: String
